...
import { prepareIframeHtml } from '@/lib/utils/iframe-html';
import type { VisualizeResult } from '@/lib/live-book/visualize-types';
...
export default function VisualizationViewer({ result }: { result: VisualizeResult }) {
  const { t } = useTranslation();
