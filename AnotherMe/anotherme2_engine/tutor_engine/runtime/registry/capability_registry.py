...
from tutor_engine.core.capability_protocol import BaseCapability
from tutor_engine.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("tutor_engine.plugins.loader")
    except Exception:
