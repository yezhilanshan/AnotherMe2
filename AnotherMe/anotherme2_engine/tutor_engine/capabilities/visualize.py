...
from tutor_engine.core.trace import merge_trace_metadata
...
class VisualizeCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        from tutor_engine.agents.visualize.pipeline import VisualizePipeline
        from tutor_engine.agents.visualize.utils import (
            build_fallback_html,
        ...
        async with stream.stage("reviewing", source=self.name):
            if analysis.render_type == "html":
                ...
                from tutor_engine.agents.visualize.models import ReviewResult
