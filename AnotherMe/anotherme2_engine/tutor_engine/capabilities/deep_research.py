...
from tutor_engine.core.trace import derive_trace_metadata, merge_trace_metadata, new_call_id
...
class DeepResearchCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        from tutor_engine.agents.research.research_pipeline import ResearchPipeline
