...
from tutor_engine.core.trace import build_trace_metadata, merge_trace_metadata, new_call_id
...
class MathAnimatorCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        from tutor_engine.agents.math_animator.pipeline import MathAnimatorPipeline
    ...
    async def _run_answer_now(
        ...
        * **Keep** ``code_generation`` + ``render`` so the user still gets
        ...
        from tutor_engine.agents.math_animator.models import ConceptAnalysis, SceneDesign
        from tutor_engine.capabilities._answer_now import (
