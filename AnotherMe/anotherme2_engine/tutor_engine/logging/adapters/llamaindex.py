...
Forwards LlamaIndex logs to Tutor Engine's unified logging system.
"""
...
class LlamaIndexLogForwarder(logging.Handler):
    """
    Handler that forwards LlamaIndex logger messages to Tutor Engine logger.
    """

    def __init__(self, ai_tutor_logger, add_prefix: bool = True):
        """
        Args:
            ai_tutor_logger: Tutor Engine Logger instance
    ...
    def emit(self, record: logging.LogRecord):
        """
        Forward log record to Tutor Engine logger.
        """
        try:
