...
Unified configuration loading for all Tutor Engine modules.
...
# PROJECT_ROOT points to the actual project root directory (Tutor Engine/)
# Path(__file__) = tutor_engine/services/config/loader.py
# .parent = tutor_engine/services/config/
# .parent.parent = tutor_engine/services/
# .parent.parent.parent = tutor_engine/
# .parent.parent.parent.parent = Tutor Engine/ (project root)
