...
Unified service layer for Tutor Engine providing:
...
Usage:
    from tutor_engine.services.llm import get_llm_client
    from tutor_engine.services.embedding import get_embedding_client
    from tutor_engine.services.rag import RAGService
    from tutor_engine.services.prompt import get_prompt_manager
    from tutor_engine.services.search import web_search
    from tutor_engine.services.setup import init_user_directories
    from tutor_engine.services.config import load_config_with_main
