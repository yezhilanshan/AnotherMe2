...
from tutor_engine.services.llm.capabilities import disable_response_format_at_runtime
from tutor_engine.services.llm.provider_core.base import LLMProvider, LLMResponse, ToolCallRequest
from tutor_engine.services.llm.provider_core.openai_responses import (
    consume_sdk_stream,
    convert_messages,
    convert_tools,
...
if TYPE_CHECKING:
    from tutor_engine.services.provider_registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/HKUDS/Tutor Engine",
    "X-OpenRouter-Title": "Tutor Engine",
}
