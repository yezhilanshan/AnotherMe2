...
from tutor_engine.services.llm.provider_core.openai_responses import consume_sse, convert_messages, convert_tools

DEFAULT_CODEX_URL = "https://chatgpt.com/backend-api/codex/responses"
DEFAULT_ORIGINATOR = "Tutor Engine"
...
def _build_headers(account_id: Any, token: Any) -> dict[str, str]:
    if not token:
        raise RuntimeError("OpenAI Codex is not logged in. Run `tutor_engine provider login openai-codex`.")
    headers = {
        "Authorization": f"Bearer {token}",
        "OpenAI-Beta": "responses=experimental",
        "originator": DEFAULT_ORIGINATOR,
        "User-Agent": "Tutor Engine (python)",
