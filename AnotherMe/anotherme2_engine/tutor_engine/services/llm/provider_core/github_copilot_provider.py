...
from tutor_engine.services.llm.provider_core.openai_compat_provider import OpenAICompatProvider
from tutor_engine.services.provider_registry import find_by_name
