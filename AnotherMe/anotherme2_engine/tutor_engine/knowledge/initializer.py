...
from tutor_engine.knowledge.progress_tracker import ProgressStage, ProgressTracker
from tutor_engine.logging import get_logger
from tutor_engine.services.rag.factory import DEFAULT_PROVIDER
from tutor_engine.services.rag.file_routing import FileTypeRouter
from tutor_engine.services.rag.service import RAGService
...
class KnowledgeBaseInitializer:
    ...
    def _register_to_config(self) -> None:
        ...
        try:
            from tutor_engine.knowledge.manager import KnowledgeBaseManager
    ...
    def _update_metadata_with_provider(self, provider: str) -> None:
        ...
        try:
            from tutor_engine.services.config import get_kb_config_service
