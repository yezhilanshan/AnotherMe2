...
Reuses:
- ``tutor_engine.services.session.get_sqlite_session_store`` for chat history
- ``tutor_engine.services.notebook.notebook_manager`` for notebook records
- ``tutor_engine.agents.notebook.NotebookAnalysisAgent`` for context distillation
"""
