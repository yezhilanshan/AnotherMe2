...
from tutor_engine.core.tool_protocol import BaseTool, ToolDefinition, ToolParameter, ToolResult
from tutor_engine.tools.prompting import load_prompt_hints
...
class BrainstormTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from tutor_engine.tools.brainstorm import brainstorm
...
class RAGTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from tutor_engine.tools.rag_tool import rag_search
...
class WebSearchTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from tutor_engine.tools.web_search import web_search
...
"""
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from tutor_engine.tools.code_executor import run_code
    ...
    async def _generate_code(self, intent: str) -> str:
        from tutor_engine.services.llm import complete, get_token_limit_kwargs
...
class ReasonTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from tutor_engine.tools.reason import reason
...
class PaperSearchToolWrapper(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from tutor_engine.tools.paper_search_tool import ArxivSearchTool
