...
from tutor_engine.agents.research.agents import (
    DecomposeAgent,
    ManagerAgent,
    NoteAgent,
    RephraseAgent,
...
from tutor_engine.agents.research.data_structures import DynamicTopicQueue
from tutor_engine.agents.research.utils.citation_manager import CitationManager
from tutor_engine.core.trace import new_call_id
from tutor_engine.logging import get_logger
from tutor_engine.runtime.registry.tool_registry import get_tool_registry
from tutor_engine.services.config import PROJECT_ROOT
...
class ResearchPipeline:
    ...
    async def run(self, topic: str) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                from tutor_engine.agents.research.utils.token_tracker import get_token_tracker
    ...
    async def _phase2_researching_parallel(self):
        ...
        from tutor_engine.agents.research.data_structures import TopicStatus
...
async def main():
    ...
    from tutor_engine.services.llm import get_llm_config
