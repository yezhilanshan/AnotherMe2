...
from tutor_engine.runtime.registry.tool_registry import ToolRegistry as CoreToolRegistry
from tutor_engine.runtime.registry.tool_registry import get_tool_registry

if TYPE_CHECKING:
    from tutor_engine.core.tool_protocol import ToolResult
...
class SolveToolRuntime:
    ...
    async def execute(
        ...
        *,
        ...
        from tutor_engine.core.tool_protocol import ToolResult as _ToolResult
