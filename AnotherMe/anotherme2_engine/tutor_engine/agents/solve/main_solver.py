...
from tutor_engine.core.trace import derive_trace_metadata, new_call_id
...
class MainSolver:
    ...
    async def _load_config(self) -> None:
        ...
        from tutor_engine.services.llm import is_local_llm_server
    ...
    def _init_logging(self) -> None:
        ...
        from tutor_engine.logging import Logger
