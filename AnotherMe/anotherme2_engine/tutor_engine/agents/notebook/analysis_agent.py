...
from tutor_engine.core.trace import build_trace_metadata, derive_trace_metadata, new_call_id
from tutor_engine.services.llm import clean_thinking_tags, get_llm_config, get_token_limit_kwargs
from tutor_engine.services.llm import stream as llm_stream
from tutor_engine.services.prompt.manager import get_prompt_manager
from tutor_engine.utils.json_parser import parse_json_response
...
class NotebookAnalysisAgent:
    ...
    def __init__(self, language: str = "en") -> None:
        ...
        # Prompts come from tutor_engine/agents/notebook/prompts/{en,zh}/analysis_agent.yaml
