...
import type { Chapter, ContentType, Spine } from "@/lib/live-book/types";
...
export default function SpineEditor({
  ...
  return (
    <div className="flex h-full flex-col">
      <header className="border-b border-[var(--border)] bg-[var(--card)]/60 px-4 py-3 md:px-6 md:py-4">
              ...
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex items-center gap-1">
                  <button
                    onClick={() => move(idx, -1)}
                    disabled={idx === 0}
                    className="rounded-md border border-[var(--border)] p-1.5 text-[var(--muted-foreground)] active:bg-[var(--muted)] disabled:opacity-30"
                  >
                  ...
                  <button
                    onClick={() => remove(idx)}
                    className="rounded-md border border-rose-300/60 p-1.5 text-rose-500 active:bg-rose-50 hover:bg-rose-50 dark:hover:bg-rose-500/10"
                  >
      ...
      <footer className="flex items-center justify-end gap-3 border-t border-[var(--border)] bg-[var(--card)]/60 px-4 py-3 md:px-6">
        <button
