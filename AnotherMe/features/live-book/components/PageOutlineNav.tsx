...
import type { Block, BlockType, BlockStatus } from "@/lib/live-book/types";
...
export default function PageOutlineNav({
  ...
  return (
    <div
      className="pointer-events-none absolute right-0 top-1/2 z-20 -translate-y-1/2 hidden md:block"
