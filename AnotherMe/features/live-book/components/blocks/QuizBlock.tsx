    ...
    <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-3">
                  ...
                  isCorrect
                    ...
                    : isWrongPick
                      ...
                      : isSelected
                        ...
                        : "border-[var(--border)] bg-[var(--card)] text-[var(--foreground)] active:border-[var(--primary)]/40 hover:border-[var(--primary)]/40"
                }`}
              >
                ...
                {isCorrect && <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0" />}
                {isWrongPick && <XCircle className="mt-0.5 h-4 w-4 shrink-0" />}
              </button>
            );
          })}
        </div>
      ...
      <div className="mt-3 flex items-center justify-between gap-2">
        <button
          ...
          className="inline-flex min-h-[40px] items-center gap-1.5 rounded-lg border border-[var(--border)] bg-[var(--card)] px-4 py-2 text-xs font-medium text-[var(--muted-foreground)] active:bg-[var(--muted)] hover:border-[var(--primary)]/40 hover:text-[var(--primary)]"
        >
          {revealed ? (
