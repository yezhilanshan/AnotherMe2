...
import { bookApi } from "@/lib/live-book/api";
...
export default function BookHealthBanner({
  ...
  return (
    <div className="mx-3 mt-4 rounded-xl border border-amber-300/60 bg-amber-50 px-4 py-3 text-sm text-amber-900 shadow-sm dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-100 md:mx-6">
