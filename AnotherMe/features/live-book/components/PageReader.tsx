...
import type { Block, BlockType, Page } from "@/lib/live-book/types";
    ...
    <div className="relative flex h-full flex-col">
      <header
        className={[
          ...
          headerCollapsed ? "px-4 py-2 md:px-8" : "px-4 py-3 md:px-8 md:py-5",
        ].join(" ")}
      >
          ...
          <article className="mx-auto flex w-full max-w-[78ch] flex-col gap-6 [&>:first-child]:mt-0">
            ...
            {onInsertBlock && (
              <div className="relative mt-2 flex justify-center">
                ...
                {showInsertMenu && (
                  <div className="absolute top-full mt-1 z-10 grid w-64 max-w-[calc(100vw-2rem)] grid-cols-2 gap-1 rounded-lg border border-[var(--border)] bg-[var(--card)] p-2 shadow-lg">
