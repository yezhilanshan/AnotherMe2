...
const CompletionPieChart = dynamic(
  () => import('./charts').then((module) => module.CompletionPieChart),
  { ssr: false, loading: () => <ChartSkeleton height={160} /> },
);
const LearningTimeChart = dynamic(
  () => import('./charts').then((module) => module.LearningTimeChart),
  { ssr: false, loading: () => <ChartSkeleton height={250} /> },
);
const TopicPieChart = dynamic(() => import('./charts').then((module) => module.TopicPieChart), {
  ssr: false,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-4 bg-white p-6 shadow-sm flex flex-col">
          ...
          <div className="flex-1 min-h-[160px] w-full" style={{ minHeight: 160 }}>
            <CompletionPieChart data={pieProgressData} />
          </div>
        ...
        <div className="lg:col-span-8 bg-white p-6 shadow-sm flex flex-col">
          ...
          <div className="flex-1 w-full min-h-[250px]" style={{ minHeight: 250 }}>
            <LearningTimeChart
              view={timeView}
              monthData={learningTimeMonth}
              weekData={learningTimeWeek}
            />
          </div>
        </div>
