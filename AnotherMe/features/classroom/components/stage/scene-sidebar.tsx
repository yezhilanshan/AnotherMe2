          ...
          {scenes.map((scene, index) => {
            ...
            return (
              <div
                ...
                className={cn(
                  'group relative rounded-lg transition-all duration-200 cursor-pointer flex flex-col gap-1 p-1.5 max-md:min-h-[44px] max-md:py-2',
                  isActive
