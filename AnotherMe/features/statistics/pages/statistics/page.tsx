...
const AbilityRadarChart = dynamic(
  ...
  {
    ssr: false,
    loading: () => <div className="h-[280px] w-full animate-pulse bg-muted" />,
  },
);
            ...
            <>
              <div className="xl:col-span-5 border border-border p-4">
                ...
                <div className="min-h-[280px]">
                  <AbilityRadarChart data={studentProfile.abilityData} />
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  <div className="bg-muted p-2.5">
                    ...
                    <p className="text-base font-bold text-foreground">
                      {studentProfile.records14d}
                    </p>
                  </div>
                  <div className="bg-muted p-2.5">
                    <p className="text-[11px] text-muted-foreground">活跃天数</p>
                    <p className="text-base font-bold text-foreground">
                      {studentProfile.activeDays}
                    </p>
                  </div>
                  <div className="bg-muted p-2.5">
